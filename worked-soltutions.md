...
### **Question 12(d)**  
**Problem:**  
When the polynomial \( P(x) \) is divided by \( (x - 1)(x + 4) \), the quotient is \( Q(x) \) and the remainder is \( R(x) = ax + b \). It is known that \( P(1) = -4 \) and when \( P(x) \) is divided by \( x + 4 \), the remainder is 1. Find \( a \) and \( b \).

**Solution:**  
1. **Apply the Remainder Theorem:**  
   - When \( P(x) \) is divided by \( (x - 1)(x + 4) \), the remainder \( R(x) \) is linear: \( R(x) = ax + b \).  
...
### **Question 11(c)**  
**Problem:**  
The polynomial \( x^4 + 4x^3 - 3x^2 + 5x - 7 = 0 \) has roots \( \alpha, \beta, \gamma, \delta \). Find \( \frac{1}{\alpha} + \frac{1}{\beta} + \frac{1}{\gamma} + \frac{1}{\delta} \).

**Solution:**  
1. **Use Vieta’s Formulas:**  
   - For a quartic polynomial \( x^4 + c_3x^3 + c_2x^2 + c_1x + c_0 = 0 \):  
     \[
     ...
     \]  
   - From coefficients:  
     - Numerator \( = -\frac{c_1}{c_4} = -\frac{5}{1} = -5 \).  
     - Denominator \( = \frac{c_0}{c_4} = \frac{-7}{1} = -7 \).  
...
### **Polynomial Remainder Question**  
**Problem:**  
The polynomials \( P(x) \) and \( Q(x) \) satisfy \( P(x) = (x+3)(x-2)Q(x) \). When \( P(x) \) is divided by \( x+1 \), the remainder is 12. What is the remainder when \( Q(x) \) is divided by \( x+1 \)?  

**Solution:**  
1. **Apply the Remainder Theorem to \( P(x) \):**  
   - \( P(-1) = (-1+3)(-1-2)Q(-1) = (2)(-3)Q(-1) = -6Q(-1) \).  
   - Given \( P(-1) = 12 \):  
     \[
     -6Q(-1) = 12 \implies Q(-1) = -2
     \]  

2. **Interpretation:**  
   - The remainder when \( Q(x) \) is divided by \( x+1 \) is \( Q(-1) = -2 \).  
...
### **Question 3**  
**Problem:**  
Solve \( \frac{3}{x-2} \leq 4 \).  

**Solution:**  
1. **Case 1:** \( x > 2 \):  
   \[
   \frac{3}{x-2} \leq 4 \implies 3 \leq 4(x-2) \implies 3 \leq 4x - 8 \implies 11 \leq 4x \implies x \geq \frac{11}{4}
   \]  

2. **Case 2:** \( x < 2 \):  
   \[
   \frac{3}{x-2} \leq 4 \implies 3 \geq 4(x-2) \implies 3 \geq 4x - 8 \implies 11 \geq 4x \implies x \leq \frac{11}{4}
   \]  
   - But \( x < 2 \), so valid solution: \( x < 2 \).  

3. **Combine solutions:**  
   \[
   x < 2 \quad \text{or} \quad x \geq \frac{11}{4}
   \]  
...
### **Question 11(c)**  
**Problem:**  
Given \( P(x) = x^3 - 2px + q \) with roots \( \alpha, \beta, \alpha + \beta \), prove \( \alpha = -\beta \) and find all roots.  

**Solution:**  
1. **Sum of roots:**  
   \[
   \alpha + \beta + (\alpha + \beta) = 0 \implies 2\alpha + 2\beta = 0 \implies \alpha = -\beta
   \]  

2. **Substitute \( \alpha = -\beta \):**  
   - Roots: \( \alpha, -\alpha, 0 \).  
   - Polynomial becomes \( x(x - \alpha)(x + \alpha) = x^3 - \alpha^2x \).  
   - Compare with \( P(x) = x^3 - 2px + q \):  
     \[
     \alpha^2 = 2p \quad \text{and} \quad q = 0
     \]  

**Final Answer:**  
Roots: \( 0, \sqrt{2p}, -\sqrt{2p} \).
...
### **Question 7**  
**Problem:**  
Find the multiplicity of the root \( x = 1 \) for \( f(x) = 3x^5 - 5x^4 + 5x - 3 \).  

**Solution:**  
1. **Check \( f(1) \):**  
   \[
   f(1) = 3(1)^5 - 5(1)^4 + 5(1) - 3 = 0
   \]  
2. **Differentiate:**  
   \[
   f'(x) = 15x^4 - 20x^3 + 5 \implies f'(1) = 15 - 20 + 5 = 0
   \]  
   \[
   f''(x) = 60x^3 - 60x^2 \implies f''(1) = 60 - 60 = 0
   \]  
   \[
   f'''(x) = 180x^2 - 120x \implies f'''(1) = 180 - 120 = 60 \neq 0
   \]  

**Final Answer:**  
Multiplicity = 3 (\( \boxed{C} \)).
